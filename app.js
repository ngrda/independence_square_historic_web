...
const buildingsDatabase = [
    {
        ...
        gallery: [
            "images/courthouse_inside.jpg",
            "images/courthouse_inside.jpg"
        ],
        bullets: [
            "<li><strong>Civic Anchor & Westward Expansion:</strong> Standing directly at the center of Independence Square, this landmark served as the absolute heart of regional government, trade, and western migration. It acted as the final staging point and vital crossroads for thousands of pioneers embarking on the historic Oregon, Santa Fe, and California Trails.</li>",
    ...
    },
    {
        ...
        bullets: [
            ...
            "<li><strong>Historical Appearance:</strong> The building retains much of its appearance from the period when Harry S. Truman was President. This can be seen in photographs taken during Truman’s administration.</li>",
    ...
    },
    {
        ...
        photoCaption: "Self-Propelled Fitness Inside Strength Saloon",
        gallery: [
            "images/gym_i.jpg",
            "images/gym_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>A Century of Adaptive Spaces:</strong> El registro histórico de inquilinos demuestra una gran flexibilidad estructural, habiendo pasado de una ferretería pesada y salas de exhibición de electrodomésticos a mediados de siglo, hasta un salón de baile, boutiques de arte creativo y modernas instalaciones de bienestar.</li>",
    ...
    },
    {
        ...
        photoCaption: "Hosts a locally owned music storefront specializing in instruments, amplification equipment, and retail gear.",
        gallery: [
            "images/music_i.jpg",
            "images/music_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Historical Appearance:</strong> Historic surveys note that portions of the original storefront and interior features survived well into the twentieth century. Particularly significant is the fact that elements of the interior from the Yantis-Fritts Drugstore era were still present when the historic survey was conducted.</li>",
            "<li><strong>Businesses Over Time:</strong> Throughout its history, the building has housed a variety of commercial businesses. This building was constructed ca. 1898. It contains two storefronts and two addresses, with office spaces on the second floor, accessed via a central staircase. The east storefront, now occupied by Music Gear, was most notably associated with pharmacies and drugstores. The Yantis-Fritts Drugstore operated at this location for approximately thirty years, making it one of the longest-running businesses known to have occupied the building.</li>",
    ...
    },
    {
        ...
        photoCaption: "Inside of the actual Exchange Courthouse Tavern, a local favorite for burgers and craft beer.",
        gallery: [
            "images/ch_inside.jpg",
            "images/ch_inside.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Businesses Over Time and the J.C. Penney Era:</strong> In its early years, the first floor hosted multiple businesses while the second floor accommodated office tenants, including attorneys-at-law and physicians. Sometime between 1918 and the 1930s, J.C. Penney moved into the building and operated there until at least 1963. Photographic archives from September 1963 and the 1970s clearly document J.C. Penney's markings on the building face, which was updated with a mid-century marble-like facade on the ground floor.</li>",
    ...
    },
    {
        ...
        bullets: [
            ...
            "<li><strong>The Clothing House and Shoe Shop Decades:</strong> During the early to mid-twentieth century, the storefront served as a core textile and utility hub on the Square, housing traditional apparel merchants and a series of long-standing family shoe repair operations that adapted seamlessly through changing downtown economic patterns.</li>",
            "<li><strong>Evolving Community Context:</strong> The location's diverse business record highlights its role as a flexible neighborhood retail space, shifting dynamically from clothing lines and beauty parlors to specialty hobby centers and creative art spaces across more than a century of service.</li>",
            ...
            "<li><strong>Current Use:</strong> Today, the historic building continues its long commercial legacy on the Square by housing Liquid Lines Studio, an interactive art experience workshop and glass gallery established in 2019. The space now thrives as a creative community hub specializing in stained glass, paint classes, and mosaic workshops, effectively blending 19th-century architecture with modern local arts.</li>"
        ]
    },
    {
        id: "blueridge",
        ...
        photoCaption: "Exterior of the Blue Ridge Bank & Trust Co.",
        gallery: [
            "images/bluerridge_out.jpg",
            "images/bluerridge_out.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Last Business located at the First National Bank Building - Bank of America",
        gallery: [
            "images/firstnational_i.jpg",
            "images/firstnational_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Financial and Civic Evolution:</strong> The address serves as a direct mirror to the shifting financial infrastructure of Jackson County, moving smoothly through changing eras of independent local trust operations, mid-century mergers, and prominent modern national banking networks.</li>",
    ...
    },
    {
        ...
        photoCaption: "Functions as a specialty retail commercial boutique and a local holistic community gathering venue.",
        gallery: [
            "images/beherenow_i.jpg",
            "images/beherenow_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Design Traits:</strong> Highly celebrated for its streamlined design language, the structure features clean horizontal bands, smooth concrete outer panels, reinforced concrete support systems, large street-level display apertures, and an absolute absence of classical ornamentation.</li>",
    ...
    },
    {
        ...
        photoCaption: "Inside Café Verona — A masterfully unified space matching raw 19th-century brickwork with high-end culinary hospitality.",
        gallery: [
            "images/cafeverona_i.jpg",
            "images/cafeverona_i.jpg"
        ],
       bullets: [
            ...
            "<li><strong>A Century of Culinary & Retail Shifts:</strong> The combined lots have supported a rich lineage of continuous independent commerce, changing dynamically across generations to serve courthouse visitors, local merchants, and shoppers from fine jewelry desks to dual-tenant barber and restaurant spaces.</li>",
    ...
    },
    {
        ...
        photoCaption: "Functions as a craft brewery and localized downtown revitalization anchor opened in 2019.",
        gallery: [
            "images/3trails_i.jpg",
            "images/3trails_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Historical Tracking:</strong> The property boasts a rich commercial legacy, transitioning from grand early-twentieth-century furniture warehouses to mid-century national variety department stores and surplus outlets before its ultimate modern culinary adaptation.</li>",
    ...
    },
    {
        ...
        photoCaption: "Functions as a fine-dining restaurant, event space, and an upper-story boutique inn overlooking the Square.",
        gallery: [
            "images/ophelias_i.jpg",
            "images/ophelias_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Historic 1890s commercial brick storefront located at 213 N. Main Street.",
        gallery: [
            "images/gateway.jpg",
            "images/gateway.jpg"
        ],
        bullets: [
            ...
            "<li><strong>A Century of Radical Adaptation:</strong> This specific location boasts one of the most uniquely diverse adaptive reuse records on the entire Square. Over a 130-year span, the interior square footage was repeatedly reconfigured to support everything from back-of-house hospitality logistics and municipal law enforcement to heavy industrial metal distribution and popular mid-century community dining rooms.</li>",
    ...
    },
    {
        ...
        photoCaption: "Historic 1883 commercial storefront known as the Hall Building at 109 S. Main Street.",
        gallery: [
            "images/hall_building_i.jpg",
            "images/hall_building_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Nutrition On the Square at 101 N. Main Street.",
        gallery: [
            "images/farmers_bank_i.jpg",
            "images/farmers_bank_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Interior view of the active screen-printing press and custom apparel workshop inside the historic Mize Building.",
        gallery: [
            "images/mize_building_i.jpg",
            "images/mize_building_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>A Landmark Hub for Grocery Giants:</strong> This commercial property played a critical role in the mid-twentieth-century food and supply infrastructure of Independence Square. It served as a premier location for pioneering national and regional grocery networks, driving massive daily foot traffic to the block for decades before transitioning into appliance showrooms and modern specialty apparel lines.</li>",
    ...
    },
    {
        ...
        gallery: [
            "images/bundschu_building_i.jpg",
            "images/bundschu_building_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Current Use:</strong> Today, the historic 1928 Bundschu Building stands as a beautifully preserved architectural landmark on the northern perimeter of the Square grid. By maintaining its striking brick facade and continuous structural utility, it bridges the Golden Age of twentieth-century retail history with the ongoing economic revitalization and adaptive commerce of downtown Independence.</li>"
        ]
    },
    {
        id: "pickens",
        ...
        photoCaption: "Pickens Sweet Treats — A classic historic commercial storefront beautifully transformed into a vibrant, family-owned candy boutique.",
        gallery: [
            "images/pickens_i.jpg",
            "images/pickens_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Family-Owned Confectionery:</strong> Owned by sisters Natalie and Nanette Pickens, the business has established a specialized niche as a primary community stop, providing handcrafted toffees, fudge, chocolates, and custom cookies.</li>",
            ...
            "<li><strong>Current Use & Foot Traffic Activation:</strong> Today, the storefront houses Pickens Sweet Treats - Candy Shop, successfully utilizing its historic pedestrian-oriented display layout to attract tourists and families, driving vital economic vitality to the Independence Square grid.</li>"
        ]
    },
    {
        id: "hrblock",
        ...
        category: "professional", // O "historical" según manejes tus categorías de producción
        ...
        photoCaption: "H&R Block Building — A classic early-20th-century commercial storefront serving as an active tax and financial planning office.",
        gallery: [
            "images/hrblock_i.jpg",
            "images/hrblock_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        category: "proffessional", // O "historical" según manejes tus categorías de producción
        ...
        photoCaption: "Scandinavia Place — An iconic early-20th-century commercial storefront serving as one of the longest-running specialty retail destinations on the Square.",
        gallery: [
            "images/scandinavia_i.jpg",
            "images/scandinavia_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Exterior of the historic 1859 Jackson County Jail and Marshal's House museum.",
        gallery: [
            "images/1859jail_i.jpg",
            "images/1859jail_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Treasures from the official collection! A beautifully arranged exhibition of Truman's personal travel pieces, mid-century memorabilia, and rare photographs tracking five iconic eras of his life.",
        gallery: [
            "images/firestation_i.jpg",
            "images/firestation_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Civic and Cultural Evolution:</strong> When the local department outgrew the facility in the early 1972-1973 window, the City of Independence seamlessly adapted the property to host community gathering initiatives. El amplio espacio de los camiones y el diseño del plano multinivel sirvieron para el doble propósito de un teatro comunitario local y oficinas administrativas municipales centralizadas.</li>",
    ...
    },
    {
        ...
        photoCaption: "Clinton's Soda Fountain interior, restored to its early 20th-century appearance.",
        gallery: [
            "images/clintons_i.jpg",
            "images/clintons_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Current Use & Living Memorial:</strong> Operates as a functioning historic-style soda fountain that educates traveling visitors on the Square's legacy. The site is anchored outside by the <em>Harry's First Job Memorial Statue</em>, which permanently connects the physical storefront back to Truman's childhood work experience.</li>"
        ]
    },
    {
        id: "elpico",
        ...
        photoCaption: "El Pico Mexican Restaurant — A beautifully adapted historic storefront driving high-energy culinary traffic along the Maple Avenue corridor.",
        gallery: [
            "images/elpico_i.jpg",
            "images/elpico_i.jpg"
        ],
        bullets: [
            "<li><strong>Historical Architecture:</strong> The structure dates from the historic period of major commercial growth in the early twentieth century, when early, vulnerable frontier frame buildings around the Square were systematically replaced by permanent brick storefronts following devastating downtown fires.</li>",
    ...
    },
    {
        ...
        photoCaption: "Pharaoh 4 Cinema — A dedicated mid-1970s theater complex anchoring the nighttime entertainment and walkability of Maple Avenue.",
        gallery: [
            "images/pharaoh_i.jpg",
            "images/pharaoh_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>Application Evolution & Key Events:</strong><ul class='timeline-nested-list'><li><strong>1975 – Independence Square Cinema Grand Opening:</strong> Inaugurated as a modern entertainment anchor to drive crucial evening consumer foot traffic to the courthouse district grid.</li><li><strong>2008 – Pharaoh 4 Rebranding:</strong> Re-engineered under independent management, adapting its business model to focus on community loyalty and versatile screen scheduling.</li><li><strong>Present – Cultural Preservation:</strong> Successfully active as an independent anchor, maintaining the structural continuity of the Square through specialized retro programming.</li></ul></li>",
    ...
    },
    {
        ...
        photoCaption: "Planet Queen Records & Vintage — An adaptable early-20th-century storefront beautifully repurposed into a dynamic indie record and nostalgia boutique.",
        gallery: [
            "images/planetqueen_i.jpg",
            "images/planetqueen_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>A Century of Specialized Trades:</strong> Prior to its contemporary musical adaptation, the lot maintained a rich multi-generational legacy as the central hub for local shoe care, cobbling, and personal grooming on Maple Avenue.</li>",
    ...
    },
    {
        ...
        photoCaption: "Emmy’s Nails — A classic early-20th-century storefront seamlessly adapted into a vibrant modern beauty and personal-care venue.",
         gallery: [
            "images/emmys_i.jpg",
            "images/emmys_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>A Dedicated Beauty Hub:</strong> In recent years, the building has maintained an incredibly consistent function, carving out a specialized niche as a primary beauty and customer-service storefront along Maple Avenue.</li>",
    ...
    },
    {
        ...
        bullets: [
            ...
            "<li><strong>Current Use:</strong> Today, the storefront houses Big John’s Corner Bar, seamlessly utilizing its historic layout to maintain vital evening foot traffic and economic activation along the west Maple Avenue corridor.</li>"
        ]
    },
    {
        id: "daves",
        ...
        photoCaption: "Dave’s Bakery & Deli — A deeply resilient storefront anchoring the culinary heritage and community gathering life of West Maple Avenue.",
        gallery: [
            "images/daves_i.jpg",
            "images/daves_i.jpg"
        ],
       bullets: [
            ...
            "<li><strong>A Century-Old Culinary Heritage:</strong> Following post-fire brick reconstruction, the storefront maintained a deep connection to food crafts, housing Union Pacific Market Meats in the 1920s, Star Bakery in 1940, and Smith’s Quality Bakery through the 1960s.</li>",
    ...
    },
    {
        ...
        photoCaption: "haupART Frame Gallery — Offering framing and art.",
        gallery: [
            "images/haupart_i.jpg",
            "images/haupart_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Wild About Harry — A classic early-20th-century commercial storefront driving nostalgic retail traffic to the historic courthouse district.",
        gallery: [
            "images/wildharry_i.jpg",
            "images/wildharry_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>A Century of Retail Excellence:</strong> The property boasts a deeply documented occupancy history, serving as a premier destination for general dry goods, essential community groceries, and high-end tailored clothing.</li>",
            ...
            "<li><strong>Current Use:</strong> Today, the storefront houses Wild About Harry, successfully utilizing its historic pedestrian-oriented layout to drive consistent tourist and community foot traffic to the Independence Square corridor.</li>"
        ]
    },
    {
        id: "gilbert-whitney",
        ...
        photoCaption: "Gilbert, Whitney & Co. — A traditional late-19th-century storefront driving boutique retail traffic to the historic Independence Square district.",
        gallery: [
            "images/gilbert_i.jpg",
            "images/gilbert_i.jpg"
        ],
        bullets: [
            ...
            "<li><strong>An Adaptable Commercial Backbone:</strong> Built to accommodate high-density trade, the building's flexible interior layout has allowed successive generations of independent merchants to navigate shifting regional marketplace trends over the course of a century.</li>",
            ...
            "<li><strong>Current Use & Civic Continuity:</strong> Today, the storefront houses Gilbert, Whitney & Co., continuing a long-standing mercantile tradition that drives crucial tourist and community foot traffic to the historic district grid.</li>"
        ]
    },
    {
        id: "designers-avenue",
        ...
        photoCaption: "Isinde of Designers Avenue Upholstery.",
        gallery: [
            "images/designersavenue_i.jpg",
            "images/designersavenue_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Austin Conley Agency advertising",
        gallery: [
            "images/austinconley_i.jpg",
            "images/austinconley_i.jpg"
        ],
        bullets: [
    ...
    },
    {
        ...
        photoCaption: "Just For You Hair & Nail — A classic pedestrian-oriented commercial storefront contributing to the historic character of North Liberty Street.",
        gallery: [
            "images/justforyou_i.jpg",
            "images/justforyou_i.jpg"
        ],
        bullets: [
...

    {
       ...
       shortDesc: "A beloved retro culinary anchor on the North Liberty corridor. Operating since circa 2011, this early-20th-century brick storefront blends a nostalgic diner-style atmosphere with a creative menu of regional-style hot dogs.",
        photoCaption: "Up Dog — A vibrant pedestrian-oriented commercial storefront contributing over a decade of culinary vitality to the historic courthouse district.",
         gallery: [
            "images/updog_i.jpg",
            "images/updog_i.jpg"
        ],
    ...
    },
    {
       ...
       photo: "images/squarepizza_n.jpg",
        ...
        photoCaption: "Square Pizza — A vibrant, pedestrian-oriented historic storefront driving exceptional dining and nostalgic lifestyle traffic to the West Square corridor.",
        gallery: [
            "images/squarepizza_i.jpg",
            "images/squarepizza_i.jpg"
        ],
        bullets: [
...
/**
 * Individual Organized Itineraries Database Asset - Premium Desglosado
 */
...
function launchTourModal(tourId) {
    ...
    // 2. Forzamos el contenedor a volver al inicio también para los Tours organizados
...
function openModal(id) {
    ...
    // 1. Forzamos el contenedor del modal a volver al inicio antes de inyectar contenido
    const modalContainer = document.getElementById("modalContainer");
    if (modalContainer) modalContainer.scrollTop = 0;
...
function closeModal() {
    // Cierra el overlay principal
    const overlay = document.getElementById("modalOverlay");
    if (overlay) overlay.classList.remove("active");
    
    // Por si acaso usas otra clase de control para los tours organizados
    const popup = document.getElementById("mobileNavPopup");
    if (popup) popup.classList.remove("popup-active");
    
    // Devuelve el scroll normal a la pantalla trasera
...
function launchTrack(trackKey) {
    ...
    // 3. Forzamos el contenedor a volver al inicio para las Rutas temáticas
    const modalContainer = document.getElementById("modalContainer");
    if (modalContainer) modalContainer.scrollTop = 0;
    ...
    const stopsHTML = track.stops.map((stopId, index) => {
        ...
        if (!item) return "";
        const excerpt = item.bullets[0] ? item.bullets[0].replace(/^(.*?):\s*/, "") : "";
        return `
...
function toggleMobileMenu() {
    ...
    // Conmutamos la clase activa para mostrar/ocultar el menú móvil
    popup.classList.toggle("popup-active");
    
    // Bloqueamos el scroll de la pantalla trasera si el menú está abierto
    document.body.style.overflow = popup.classList.contains("popup-active") ? "hidden" : "";
}

function handleMobileLinkClick() {
    // Al hacer clic en un enlace del menú móvil, lo cerramos automáticamente
    toggleMobileMenu();
}